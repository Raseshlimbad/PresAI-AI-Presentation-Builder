...
const TemplateGrid = ({ templates, selectedCategory, onSelectTemplate, categories }: TemplateGridProps) => {
        ...
        {templates.map(template => (
          ...
          >
            <div className="aspect-video bg-gray-50 p-4 flex items-center justify-center">
              {template.slides[0] && (
                <div className={`w-full scale-[0.6] ${template.slides[0].className}`}>
            ...
            <CardContent className="p-4">
              ...
              <p className="text-sm text-gray-500">{template.slides.length} slides</p>
            </CardContent>
          </Card>
        ))}
      </div>
